...
import { Trash, Star, ImageIcon, Pencil } from "lucide-react";
    ...
    <>
          ...
          <tbody className="bg-gray-800 divide-y divide-gray-700">
            {products.map((product) => {
              ...
              return (
                <tr
                  key={product._id}
                  className="hover:bg-gray-700/60 transition"
                >
                  {/* PRODUCT */}
      ...
      {editingProduct && (
        <EditProductModal
          ...
          onSave={async (data) => {
            console.log("🚀 CALLING updateProduct", editingProduct._id, data);
